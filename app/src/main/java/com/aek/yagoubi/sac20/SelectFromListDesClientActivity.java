...
import com.aek.yagoubi.sac20.Adapters.SelectClientAdapter;
import com.aek.yagoubi.sac20.Object.Client;

import java.util.ArrayList;

public class SelectFromListDesClientActivity extends AppCompatActivity {
    Database database;
    ArrayList<Client> clients;
    SelectClientAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new SelectClientAdapter(this, clients);
        ...
        serchInput.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (s == null || s.length() == 0) {
                    adapter = new SelectClientAdapter(SelectFromListDesClientActivity.this, clients);
                } else {
                    ...
                    adapter = new SelectClientAdapter(SelectFromListDesClientActivity.this, newArraySearch);
                }
        ...
        showAjouterClientBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SelectFromListDesClientActivity.this, AjouterClientActivity.class);
